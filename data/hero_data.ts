...
export const HERO_DEFINITIONS: HeroDefinition[] = [
  ...
  { name: "ScoutRat", rarity: "C", hp: 50, ability: "採掘速度 +5%", species: "Other" },
  { name: "MedicalHamster", rarity: "C", hp: 50, ability: "チームの受けるダメージが -1%　・　チームのクエスト報酬  -5%", species: "Other" },
  { name: "ScoutDog", rarity: "C", hp: 50, ability: "採掘速度 +5%", species: "Dog" },
  { name: "ScoutMonkey", rarity: "C", hp: 50, ability: "採掘速度 +5%", species: "Other" },
  ...
  { name: "ScoutPenguin", rarity: "C", hp: 50, ability: "採掘速度 +5%", species: "Bird" },
  ...
  { name: "ScoutGorilla", rarity: "UC", hp: 60, ability: "採掘速度 +20%", species: "Other" },
  { name: "ScoutCat", rarity: "R", hp: 80, ability: "採掘速度 +10%", species: "Cat" },
