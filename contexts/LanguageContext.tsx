...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Notifications
    'notify.insufficient_tokens': 'Insufficient tokens! (Required: {amount} $CHH)',
    'notify.quest_load_failed': 'Failed to load quest data.',
    'notify.party_busy': 'This party is already on a mission. Please select another party.',
    'notify.party_incomplete': 'You need 3 heroes in your party! Please assign them.',
    'notify.hero_hp_zero': 'Some heroes have 0 HP. Please recover them.',
    'notify.no_completed_quests': 'No completed quests found.',
    'notify.quest_loading': 'Loading quest data. Please wait and try again.',
    'notify.quest_sync_error': 'Quest sync error (ID: {id}): {message}',
    'notify.gacha_error': 'Gacha error: {message}',
    'notify.miniapp_registered': 'Registered as MiniApp!',
    'notify.fc_login_error': 'FC Login Error: {message}',
    'notify.potion_purchased': 'Purchased {amount} Potion(s)',
    ...
    'notify.no_potion': 'You do not have any Potions',
    'notify.hero_recovered': 'Recovered {name} (+10HP)',
    'notify.no_elixir': 'You do not have any Elixirs',
    'notify.hero_fully_recovered': 'Fully recovered {name}',
    'notify.item_not_found': 'Item not found',
    'notify.merge_invalid': 'Only equipment of the same type, rarity, and level can be merged',
    'notify.material_equipped': 'Equipped items cannot be used as materials',
    'notify.equip_enhanced': 'Equipment enhanced! (+{level})',
    'notify.merge_error': 'An error occurred during enhancement',
    'notify.debug_tokens_added': 'Debug: Added 10,000 $CHH',

    // App
    'app.confirm_reset': 'Reset connection settings and return to setup screen?\n(Entered API key information will be deleted)',
    ...
    'quest.log_fainted': '💀 {name} has fainted... (HP 0)',
    'quest.log_damage': '💥 {name}: -{damage} HP (Left: {hp})',
    'quest.log_safe': '🛡️ {name}: Returned safely without a scratch!',
    'quest.log_party_wiped': '❌ Party wiped out! Quest failed. No rewards obtained.',
  ...
  ja: {
    ...
    // Notifications
    'notify.insufficient_tokens': 'トークンが足りません！ (必要: {amount} $CHH)',
    'notify.quest_load_failed': 'クエストデータの読み込みに失敗しました。',
    'notify.party_busy': 'このパーティは既に任務中です。別のパーティを選択してください。',
    'notify.party_incomplete': 'パーティは3人揃える必要があります！編成してください。',
    'notify.hero_hp_zero': 'HPが0のヒーローがいます。回復してください。',
    'notify.no_completed_quests': '完了したクエストはありません。',
    'notify.quest_loading': 'クエストデータの読み込み中です。しばらく待ってから再試行してください。',
    'notify.quest_sync_error': 'クエスト同期エラー (ID: {id}): {message}',
    'notify.gacha_error': 'ガチャエラー: {message}',
    'notify.miniapp_registered': 'MiniAppとして登録しました！',
    'notify.fc_login_error': 'FC Login Error: {message}',
    'notify.potion_purchased': 'ポーションを{amount}個購入しました',
    ...
    'notify.no_potion': 'ポーションを持っていません',
    'notify.hero_recovered': '{name}を回復しました (+10HP)',
    'notify.no_elixir': 'エリクサーを持っていません',
    'notify.hero_fully_recovered': '{name}を全回復しました',
    'notify.item_not_found': 'アイテムが見つかりません',
    'notify.merge_invalid': '同じ種類・レアリティ・レベルの装備のみマージ可能です',
    'notify.material_equipped': '装備中のアイテムは素材にできません',
    'notify.equip_enhanced': '装備を強化しました！ (+{level})',
    'notify.merge_error': '強化処理中にエラーが発生しました',
    'notify.debug_tokens_added': 'デバッグ: 10,000 $CHHを追加しました',

    // App
    'app.confirm_reset': '接続設定をリセットして、セットアップ画面に戻りますか？\n(入力されたAPIキー情報は削除されます)',
    ...
    'quest.log_fainted': '💀 {name} は力尽きた... (HP 0)',
    'quest.log_damage': '💥 {name}: -{damage} HP (残: {hp})',
    'quest.log_safe': '🛡️ {name}: 無傷で生還！',
    'quest.log_party_wiped': '❌ パーティ全滅！クエスト失敗。報酬は得られません。',
